...
def get_vertical_edge(SRC_PATH):
	...
	# img_str = str(img)
	# img = str_to_numpy(img_str)
	# print(img)
	# netcat('192.168.42.22', 40000, img_bytes)
...
def get_horizontal_edge(SRC_PATH):
	...
	if (min_line is None):
		print('None min_line')
		return
	full_line, distance_to_horizontal = get_full_line(min_line, y_max, x_max, True)
